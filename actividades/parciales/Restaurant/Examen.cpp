...
void Examen::Punto1(){
    ...
    float puntajeTotal = 0, promedio = 0;
...
/**
    Listar el numero de plato que recaudo mayor cantidad de dinero
*/
void Examen::Punto2(){
    ...
    int cantidadServiciosMesa = aServicioMesa.CantidadRegistros();

    for(int i =0; i< cantidadServiciosMesa; i ++){
        registro = aServicioMesa.Leer(i);
...
/**
    Listar el numero de mozo que recibio mayor cantidad total de propinas en el año 2024
*/
void Examen::Punto3(){
